...
<p id="htaccess-description">
		...
		printf(
			...
			__( 'If your %1$s file was <a href="%2$s">writable</a>, we could do this automatically, but it isn&#8217;t so these are the mod_rewrite rules you should have in your %1$s file. Click in the field and press %3$s (or %3$s on mac) to select all.' ),
			'<code>.htaccess</code>',
			__( 'https://wordpress.org/support/article/changing-file-permissions/' ),
			'<kbd>CTRL + a</kbd>',
			'<kbd>⌘ + A</kbd>'
